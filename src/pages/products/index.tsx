...
const ProductsPage: React.FC=() => {
  ...
  useEffect(() => {
    ...
    const fetchProductsDataAll = async () => {
      setIsLoading(true);
      try {
        const products = await fetchProducts();  // Call your fetchProducts from lib
        setProductsList(products);  // Update the state with the fetched products
      } catch (err) {
    ...
    fetchProductsDataAll();  // Call the function on component mount
  }, []); 
